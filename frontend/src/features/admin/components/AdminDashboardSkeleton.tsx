      ...
      <main className="max-w-7xl mx-auto pt-32 px-6 pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white/5 border border-white/10 p-8 rounded-3xl backdrop-blur-sm shadow-xl">
            ...
            <Skeleton className="h-[300px] w-full rounded-2xl opacity-40" />
          </div>
          ...
          <div className="bg-white/5 border border-white/10 p-8 rounded-3xl backdrop-blur-sm shadow-xl lg:col-span-2">
            ...
            <Skeleton className="h-[400px] w-full rounded-2xl opacity-40" />
          </div>
        </div>
          ...
          <div className="p-8 space-y-4">
            {[...Array(5)].map((_, i) => (
              <div key={i} className="flex items-center justify-between py-2 border-b border-white/5 last:border-0">
                ...
                <div className="flex gap-4">
                  {[...Array(4)].map((_, j) => (
                    <Skeleton key={j} className="w-4 h-4 rounded-full opacity-40" />
                  ))}
                  <Skeleton className="w-16 h-6 rounded-lg opacity-40" />
                </div>
              </div>
            ))}
          </div>
